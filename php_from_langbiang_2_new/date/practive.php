...
<head>
  ...
  <style type="text/css">
    * { margin: 0px; padding: 0px; }
    .content { margin: 20px auto; width: 600px;  border: 2px solid #ddd;           padding: 10px; background:url('89f94f96d116719d713ace3278664e9c.jpg') no-repeat center;background-size:cover; }
...
<body>
  ...
  <div class="content">
    ...
    <form action="#" method="POST" id="mainForm" name="mainForm">
      <div class="row">
        <span>Ngày </span><?php echo $strDays; ?>
      </div>
      <div class="row"><span>Tháng: </span><?php echo $strMonths; ?></div>
      <div class="row"><span>Năm:  </span><?php echo $strYears; ?></div>
      <div class="row">
        <input type="submit" name="" value="Check date">
      </div>
      <div class="result"><span>Ngưởi dùng đã nhập: </span>
        <?php 
